...
public class Quart
{
    ...
    implements IEase
  {
    public float ease(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float[] paramArrayOfFloat)
    {
      ...
      return paramFloat3 * paramFloat1 * paramFloat1 * paramFloat1 * paramFloat1 + paramFloat2;
    }
  }
    ...
    implements IEase
  {
    public float ease(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float[] paramArrayOfFloat)
    {
      ...
      if (paramFloat1 < 1.0F)
        return paramFloat3 / 2.0F * paramFloat1 * paramFloat1 * paramFloat1 * paramFloat1 + paramFloat2;
      paramFloat3 = -paramFloat3 / 2.0F;
      paramFloat1 -= 2.0F;
      return paramFloat3 * (paramFloat1 * paramFloat1 * paramFloat1 * paramFloat1 - 2.0F) + paramFloat2;
    }
  }
    ...
    implements IEase
  {
    public float ease(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float[] paramArrayOfFloat)
    {
      ...
      return paramFloat3 * (paramFloat1 * paramFloat1 * paramFloat1 * paramFloat1 - 1.0F) + paramFloat2;
    }
  }
}
