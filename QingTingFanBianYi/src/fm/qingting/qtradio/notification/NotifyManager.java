...
public class NotifyManager
{
    ...
    throws IOException
  {
    ...
    Object localObject5 = new BasicHttpParams();
    ...
    if (localHttpEntity != null)
    {
      ...
      try
      {
        ...
        localObject4 = localObject1;
        paramHttpUriRequest = (HttpUriRequest)localObject1;
        localObject6 = this.sharedPrefs.edit();
        localObject3 = localObject1;
        localObject4 = localObject1;
        paramHttpUriRequest = (HttpUriRequest)localObject1;
        ((SharedPreferences.Editor)localObject6).putString("lastmodified", (String)localObject5);
        localObject3 = localObject1;
        localObject4 = localObject1;
        paramHttpUriRequest = (HttpUriRequest)localObject1;
