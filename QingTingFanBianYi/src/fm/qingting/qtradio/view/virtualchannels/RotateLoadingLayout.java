...
class RotateLoadingLayout extends LoadingLayout2
{
  ...
  private final ViewLayout imageLayout = this.standardLayout.createChildLT(50, 50, 335, 215, ViewLayout.SCALE_FLAG_SLTCW);
  ...
  private final ViewLayout textLayout = this.standardLayout.createChildLT(200, 50, 260, 265, ViewLayout.SCALE_FLAG_SLTCW);
 ...
 * Qualified Name:     fm.qingting.qtradio.view.virtualchannels.RotateLoadingLayout
