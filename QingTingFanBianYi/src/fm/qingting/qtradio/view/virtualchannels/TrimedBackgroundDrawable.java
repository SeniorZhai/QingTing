...
class TrimedBackgroundDrawable extends Drawable
{
  ...
  public TrimedBackgroundDrawable(Resources paramResources, Bitmap paramBitmap)
  {
    this(new BitmapState(paramBitmap), paramResources);
    this.mBitmapState.mTargetDensity = this.mTargetDensity;
  }

  public TrimedBackgroundDrawable(Bitmap paramBitmap)
  {
    this(new BitmapState(paramBitmap), null);
  }

  private TrimedBackgroundDrawable(BitmapState paramBitmapState, Resources paramResources)
  {
  ...
  static final class BitmapState extends Drawable.ConstantState
  {
    ...
    {
      return new TrimedBackgroundDrawable(this, null, null);
    }

    public Drawable newDrawable(Resources paramResources)
    {
      return new TrimedBackgroundDrawable(this, paramResources, null);
    }
  }
}

/* Location:           C:\Users\User\dex2jar-2.0\dex\qting\classes-dex2jar.jar
 * Qualified Name:     fm.qingting.qtradio.view.virtualchannels.TrimedBackgroundDrawable
