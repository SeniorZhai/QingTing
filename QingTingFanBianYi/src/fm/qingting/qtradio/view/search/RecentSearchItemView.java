...
public class RecentSearchItemView extends QtView
{
  ...
  private final ViewLayout nameLayout = this.itemLayout.createChildLT(600, 68, 30, 0, ViewLayout.SCALE_FLAG_SLTCW);

  public RecentSearchItemView(Context paramContext, int paramInt)
  {
    super(paramContext);
    ...
    this.mBg.setOnElementClickListener(new ViewElement.OnElementClickListener()
    {
      ...
      {
        if (RecentSearchItemView.this.mName != null)
          RecentSearchItemView.this.dispatchActionEvent("searchRecent", RecentSearchItemView.this.mName);
      }
    });
 ...
 * Qualified Name:     fm.qingting.qtradio.view.search.RecentSearchItemView
