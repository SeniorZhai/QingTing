...
public class ImBlockRemindPopView extends QtView
{
  ...
  public ImBlockRemindPopView(Context paramContext)
  {
    super(paramContext);
    ...
    this.mNameElement.setText(localResources.getString(2131492889), false);
    ...
    this.mArrayElement.setOnArrayClickListenrer(new ButtonArrayElement.OnButtonArrayClickListener()
    {
      public void OnArrayClick(ViewElement paramAnonymousViewElement, int paramAnonymousInt)
      {
        ...
        default:
          return;
        case 0:
          ImBlockRemindPopView.this.dispatchActionEvent("cancelPop", null);
          ImBlackList.addToBlackList(ImBlockRemindPopView.this.getContext(), ImBlockRemindPopView.this.mMessage);
          return;
        case 1:
        }
        ImBlockRemindPopView.this.dispatchActionEvent("cancelPop", null);
 ...
 * Qualified Name:     fm.qingting.qtradio.view.popviews.ImBlockRemindPopView
