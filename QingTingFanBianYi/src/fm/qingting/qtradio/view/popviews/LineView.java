...
{
  private final ViewLayout lineLayout = this.standardLayout.createChildLT(114, 1, 0, 0, ViewLayout.SCALE_FLAG_SLTCW);
  private Paint mLinePaint = new Paint();
  private final ViewLayout standardLayout = ViewLayout.createViewLayoutWithBoundsLT(114, 2, 114, 2, 0, 0, ViewLayout.FILL);
 ...
 * Qualified Name:     fm.qingting.qtradio.view.popviews.LineView
