...
public class BlackListView extends ViewGroupViewImpl
{
  ...
  public BlackListView(Context paramContext)
  {
    super(paramContext);
    final int i = hashCode();
    setBackgroundColor(SkinManager.getBackgroundColor());
    this.mEmptyView = new EmptyTipsView(paramContext, 10);
    addView(this.mEmptyView);
    this.mFactory = new IAdapterIViewFactory()
    {
      public IView createView(int paramAnonymousInt)
      {
        return new BlockedItemView(BlackListView.this.getContext(), i);
      }
    };
 ...
 * Qualified Name:     fm.qingting.qtradio.view.im.BlackListView
