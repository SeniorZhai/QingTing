...
public class MyGroupsView extends ViewGroupViewImpl
{
  ...
  public MyGroupsView(Context paramContext)
  {
    super(paramContext);
    final int i = hashCode();
    setBackgroundColor(SkinManager.getBackgroundColor());
    this.mEmptyView = new EmptyTipsView(paramContext, 4);
    addView(this.mEmptyView);
    this.mFactory = new IAdapterIViewFactory()
    {
      public IView createView(int paramAnonymousInt)
      {
        return new GroupItemView(MyGroupsView.this.getContext(), i);
      }
    };
 ...
 * Qualified Name:     fm.qingting.qtradio.view.im.MyGroupsView
