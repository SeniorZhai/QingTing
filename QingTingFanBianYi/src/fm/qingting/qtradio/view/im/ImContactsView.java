...
public class ImContactsView extends ViewGroupViewImpl
{
  ...
  public ImContactsView(Context paramContext)
  {
    super(paramContext);
    ...
    this.mFactory = new IPinnedAdapterIViewFactory()
    {
      public IView createView(int paramAnonymousInt)
      {
        ...
        default:
          return null;
        case 1:
          return new CustomSectionView(ImContactsView.this.getContext());
        case 0:
          return new ContactsItemView(ImContactsView.this.getContext(), this.val$hash);
        case 2:
        }
        return new SpecialContactsItemView(ImContactsView.this.getContext(), this.val$hash);
      }
    };
    ...
    this.mQuickQueryView.setChangeListener(new QuickQueryView.OnTouchingLetterChangeListener()
    {
      ...
      {
        int i = ImContactsView.this.findIndex(paramAnonymousString);
        if (i < 0)
          return;
        ImContactsView.this.mListView.setSelection(i);
      }
    });
  }
  ...
  private void setData(List<UserInfo> paramList)
  {
    ...
    localArrayList1.add(new SpecialPinnedItem(1, "分组"));
    localArrayList1.add(new SpecialPinnedItem(2, new SpecialContactsItem("群组", 2130837826, 0)));
    localArrayList1.add(new SpecialPinnedItem(2, new SpecialContactsItem("关注", 2130837825, 1)));
    localArrayList1.add(new SpecialPinnedItem(2, new SpecialContactsItem("粉丝", 2130837824, 2)));
    localArrayList1.add(new SpecialPinnedItem(2, new SpecialContactsItem("黑名单", 2130837823, 3)));
 ...
 * Qualified Name:     fm.qingting.qtradio.view.im.ImContactsView
