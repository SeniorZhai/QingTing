  ...
  implements ViewElement.OnElementClickListener
{
  ...
  private String getName()
  {
    ...
    do
    {
      ...
      {
        String str2 = ((ProgramNode)this.mInfo.mNode).getChannelName();
        String str1 = str2;
        if (str2 == null)
          str1 = this.mInfo.belongName;
        return "【" + str1 + "】" + this.mInfo.name;
      }
    ...
    for (i = 1; ; i = 0)
    {
      if (i != 0)
      {
        ...
        if (paramLong < 3600000L)
          return String.format(Locale.CHINESE, "%d分钟前", new Object[] { Integer.valueOf((int)(paramLong / 1000L)) });
        if (paramLong < 10800000L)
          return String.format(Locale.CHINESE, "%d小时前", new Object[] { Integer.valueOf((int)(paramLong / 1000L / 60L)) });
      }
      else
      {
