...
public class DiscoverItemRecommendTagView extends QtView
  implements ViewElement.OnElementClickListener
{
  ...
  public DiscoverItemRecommendTagView(Context paramContext, int paramInt)
  {
    super(paramContext);
 ...
 * Qualified Name:     fm.qingting.qtradio.view.frontpage.discover.DiscoverItemRecommendTagView
