...
class RadioTagView extends QtView
{
  ...
  public RadioTagView(Context paramContext, int paramInt)
  {
    super(paramContext);
  ...
  public void update(String paramString, Object paramObject)
  {
    if (paramString.equalsIgnoreCase("setData"))
      this.mTag.setText((String)paramObject);
  }
}

/* Location:           C:\Users\User\dex2jar-2.0\dex\qting\classes-dex2jar.jar
 * Qualified Name:     fm.qingting.qtradio.view.frontpage.discover.RadioTagView
