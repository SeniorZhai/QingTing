...
public class DiscoverItemAdItemView extends QtView
  implements ViewElement.OnElementClickListener
{
  ...
  public DiscoverItemAdItemView(Context paramContext, int paramInt)
  {
    super(paramContext);
 ...
 * Qualified Name:     fm.qingting.qtradio.view.frontpage.discover.DiscoverItemAdItemView
