  ...
  public DiscoverCampusView(Context paramContext)
  {
    ...
    this.mFactory = new ISectionFactory()
    {
      public IView createView(int paramAnonymousInt)
      {
        ...
        case 7:
          localDiscoverAdItemView = new DiscoverAdItemView(DiscoverCampusView.this.getContext(), i);
          localDiscoverAdItemView.setListener(new DiscoverAdItemView.OnDeleteListener()
          {
            public void onDelete()
            {
              DiscoverCampusView.this.mListView.setOnScrollListener(null);
              DiscoverCampusView.access$102(DiscoverCampusView.this, null);
              DiscoverCampusView.access$202(DiscoverCampusView.this, null);
        ...
        localDiscoverAdItemView.setListener(new DiscoverAdItemView.OnDeleteListener()
        {
          ...
          {
            DiscoverCampusView.this.mListView.setOnScrollListener(null);
            DiscoverCampusView.access$502(DiscoverCampusView.this, null);
            DiscoverCampusView.this.setData(DiscoverCampusView.this.mRecommendCategoryNode);
          }
        });
        return localDiscoverAdItemView;
    ...
    this.mListView.setOnScrollListener(new AbsListView.OnScrollListener()
    {
      ...
      {
        if (DiscoverCampusView.this.mAdNode == null)
          DiscoverCampusView.this.load3rdPartyAd();
      }
