...
class CampusTagView extends QtView
{
  ...
  public CampusTagView(Context paramContext, int paramInt)
  {
    super(paramContext);
 ...
 * Qualified Name:     fm.qingting.qtradio.view.frontpage.discover.CampusTagView
