...
class NovelCategoryView extends QtView
  implements ViewElement.OnElementClickListener, InfoManager.ISubscribeEventListener
{
  ...
  public NovelCategoryView(Context paramContext)
  {
    super(paramContext);
 ...
 * Qualified Name:     fm.qingting.qtradio.view.frontpage.discover.NovelCategoryView
