...
public class TimerItemView extends QtView
{
  ...
  public TimerItemView(Context paramContext, int paramInt)
  {
    super(paramContext);
    ...
    this.mBg.setOnElementClickListener(new ViewElement.OnElementClickListener()
    {
      ...
      {
        if (TimerItemView.this.mItem != null)
          TimerItemView.this.handleClickEvent(TimerItemView.this.mItem.getId());
      }
    });
  ...
  private void handleClickEvent(String paramString)
  {
    if (this.mCheck.isChecked())
      return;
    dispatchActionEvent("check", paramString);
  }
 ...
 * Qualified Name:     fm.qingting.qtradio.view.personalcenter.timer.TimerItemView
