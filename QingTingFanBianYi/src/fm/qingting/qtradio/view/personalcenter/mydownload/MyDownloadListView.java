...
public class MyDownloadListView extends ListViewImpl
  implements IEventHandler
{
  ...
  private IAdapterIViewFactory factory = new IAdapterIViewFactory()
  {
    ...
    {
      return new MyDownloadItemView(MyDownloadListView.this.getContext(), this.val$hash);
    }
  };
  private int mFirstPosition = 0;
  private int mVisibleCnt = 0;

  public MyDownloadListView(Context paramContext)
  {
    super(paramContext);
    ...
    setOnScrollListener(new AbsListView.OnScrollListener()
    {
      ...
      {
        MyDownloadListView.access$002(MyDownloadListView.this, paramAnonymousInt1);
        MyDownloadListView.access$102(MyDownloadListView.this, paramAnonymousInt2);
      }
 ...
 * Qualified Name:     fm.qingting.qtradio.view.personalcenter.mydownload.MyDownloadListView
