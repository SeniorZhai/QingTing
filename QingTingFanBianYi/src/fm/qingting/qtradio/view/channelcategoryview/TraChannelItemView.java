...
public class TraChannelItemView extends QtView
  implements ViewElement.OnElementClickListener
{
  ...
  public TraChannelItemView(Context paramContext, int paramInt)
  {
    super(paramContext);
  ...
  public void onElementClick(ViewElement paramViewElement)
  {
    ...
    paramViewElement = InfoManager.getInstance().h5Channel(this.mNode.channelId);
 ...
 * Qualified Name:     fm.qingting.qtradio.view.channelcategoryview.TraChannelItemView
