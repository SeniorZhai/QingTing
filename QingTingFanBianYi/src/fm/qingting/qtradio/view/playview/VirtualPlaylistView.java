...
public class VirtualPlaylistView extends LoadMoreListView
{
  ...
  private IAdapterIViewFactory mFactory = new IAdapterIViewFactory()
  {
    ...
    {
      return new VirtualPlaylistItemView(VirtualPlaylistView.this.getContext(), this.val$hash);
    }
  };

  public VirtualPlaylistView(Context paramContext)
  {
    super(paramContext);
    setDivider(null);
 ...
 * Qualified Name:     fm.qingting.qtradio.view.playview.VirtualPlaylistView
