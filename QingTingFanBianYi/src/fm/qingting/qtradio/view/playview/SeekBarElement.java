...
public class SeekBarElement extends AbsSeekBarElement
{
  ...
  public SeekBarElement(Context paramContext)
  {
    super(paramContext);
  }
  ...
  protected void drawProgressBg(Canvas paramCanvas)
  {
    ...
    paramCanvas.drawColor(1275068416);
  ...
  {
    paramCanvas.drawBitmap(BitmapResourceCache.getInstance().getResourceCacheByParent(getContext().getResources(), this.mOwnerId, 2130837803), null, this.mThumbRect, this.mPaint);
  }
 ...
 * Qualified Name:     fm.qingting.qtradio.view.playview.SeekBarElement
