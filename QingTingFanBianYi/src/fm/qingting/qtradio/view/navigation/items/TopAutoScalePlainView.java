...
public class TopAutoScalePlainView extends QtListItemView
{
  ...
  private void drawButton(Canvas paramCanvas)
  {
    ...
    {
      paramCanvas.drawText(str, f1, f2 - f3, localPaint);
      if (this.mTip == null)
        break;
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    this.mNormalPaint.setTextSize(this.standardLayout.height * 0.45F);
    this.mHighlightPaint.setTextSize(this.standardLayout.height * 0.45F);
