...
public class DanmakuPlayButtonsView extends QtView
  implements ViewElement.OnElementClickListener, IMediaEventListener, DownLoadInfoNode.IDownloadInfoEventListener
{
  ...
  private DanmakuPlayButtonElement mPlayElement;
  ...
  public DanmakuPlayButtonsView(Context paramContext)
  {
    super(paramContext);
    int i = hashCode();
    int j = ScreenConfiguration.getCustomExtraBound() * 2;
    this.mPlayElement = new DanmakuPlayButtonElement(paramContext);
    ...
    this.mPreElement.setBackground(2130837787, 2130837521, 2130837521);
    ...
    this.mNextElement.setBackground(2130837780, 2130837516, 2130837516);
    ...
    this.mScheduleElement.setBackground(2130837789, 2130837522);
    ...
    this.mDownloadElement.setBackground(2130837769, 2130837514);
  ...
  private void download()
  {
    ...
    {
      if (!localChannelNode1.isMusicChannel())
        break label45;
  ...
  public void onDownLoadInfoUpdated(int paramInt, Node paramNode)
  {
    ...
    if (this.mNode.isDownloadProgram())
      this.mDownloadElement.setBackground(2130837515, 2130837515);
    while (true)
    {
      invalidate();
      return;
  ...
  public void update(String paramString, Object paramObject)
  {
    ...
    while (true)
    {
      ...
      while (true)
      {
        ...
        this.mDownloadElement.setBackground(2130837769, 2130837514);
        break;
        label281: paramString = InfoManager.getInstance().root().getCurrentPlayingChannelNode();
      ...
      label414: bool1 = false;
    }
  }
}

/* Location:           C:\Users\User\dex2jar-2.0\dex\qting\classes-dex2jar.jar
 * Qualified Name:     fm.qingting.qtradio.view.playview_bb.DanmakuPlayButtonsView
