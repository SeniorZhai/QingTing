...
import fm.qingting.qtradio.view.playview.AbsSeekBarElement.OnSeekBarChangeListener;
import fm.qingting.utils.OnPlayProcessListener;
import fm.qingting.utils.PlayProcessSyncUtil;
import java.util.Calendar;
import java.util.Locale;

public class DanmakuSeekBarView extends QtView
  implements OnPlayProcessListener, AbsSeekBarElement.OnSeekBarChangeListener
{
  ...
  private DanmakuSeekBarElement mSeekBarElement;
  ...
  public DanmakuSeekBarView(Context paramContext)
  {
    super(paramContext);
    int i = hashCode();
    this.mSeekBarElement = new DanmakuSeekBarElement(paramContext);
 ...
 * Qualified Name:     fm.qingting.qtradio.view.playview_bb.DanmakuSeekBarView
