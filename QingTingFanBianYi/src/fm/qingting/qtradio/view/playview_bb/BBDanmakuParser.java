...
public class BBDanmakuParser extends BaseDanmakuParser
{
  ...
  public class XmlContentHandler extends DefaultHandler
  {
      ...
      label673: for (paramInt1 = (int)(Float.parseFloat(localObject1[1]) * f1); ; paramInt1 = paramInt2)
      {
        ...
        for (float f4 = Float.parseFloat(paramArrayOfChar[6]); ; f4 = 0.0F)
        {
          ...
          while (true)
          {
            ...
            DanmakuFactory.fillTranslationData(this.item, f5, f6, f1, f2, l1, l3, BBDanmakuParser.this.mDispScaleX, BBDanmakuParser.this.mDispScaleY);
            ...
            DanmakuFactory.fillLinePathData(this.item, (float[][])localObject1, BBDanmakuParser.this.mDispScaleX, BBDanmakuParser.this.mDispScaleY);
            return;
            continue;
            l1 = l2;
            break label349;
      ...
      throws SAXException
    {
      ...
      while (true)
      {
        ...
        {
          this.item.setTimer(BBDanmakuParser.this.mTimer);
      ...
      while (true)
      {
        if (paramString2.toLowerCase(Locale.getDefault()).trim().equals("d"))
        {
          ...
          if (paramString1.length > 0)
          {
            ...
            this.item = DanmakuFactory.createDanmaku(k, BBDanmakuParser.this.mDisp);
            if (this.item != null)
            {
              this.item.time = l;
              this.item.textSize = ((BBDanmakuParser.this.mDispDensity - 0.6F) * f);
              this.item.textColor = -11908534;
              this.item.drawableLeftResid = 2130837578;
 ...
 * Qualified Name:     fm.qingting.qtradio.view.playview_bb.BBDanmakuParser
