...
class ChatAdapter extends BaseAdapter
{
  ...
  public ChatAdapter(List<ChatItem> paramList, IChatAdapterIViewFactory paramIChatAdapterIViewFactory)
  {
    this.data = paramList;
 ...
 * Qualified Name:     fm.qingting.qtradio.view.chatroom.chatlist.ChatAdapter
