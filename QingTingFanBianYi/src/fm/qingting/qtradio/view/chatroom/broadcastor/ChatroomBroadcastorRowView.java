...
public class ChatroomBroadcastorRowView extends ViewGroupViewImpl
  implements IEventHandler
{
  private BroadcastorScrollView mScrollView;
  private final ViewLayout standardLayout = ViewLayout.createViewLayoutWithBoundsLT(500, 160, 500, 160, 0, 0, ViewLayout.FILL);

  public ChatroomBroadcastorRowView(Context paramContext)
  {
    super(paramContext);
    this.mScrollView = new BroadcastorScrollView(paramContext);
 ...
 * Qualified Name:     fm.qingting.qtradio.view.chatroom.broadcastor.ChatroomBroadcastorRowView
