  ...
  implements View.OnLongClickListener, View.OnClickListener
{
  ...
  private void onTouchDown(MotionEvent paramMotionEvent)
  {
    ...
    if ((paramMotionEvent instanceof DraggableItem))
    {
      ((DraggableItem)paramMotionEvent).setState(1);
      return;
    }
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    if ((this.mAdapter == null) || (this.mChildren == null))
      throw new IllegalStateException("u should call setDragDropAdapter right after constructor");
    int j = this.mAdapter.getColumnCount();
    ...
    while (i < k)
    {
      ((IView)this.mChildren.get(i)).getView().measure(m, paramInt2);
      if (i == 0)
    ...
    {
      setMeasuredDimension(View.MeasureSpec.getSize(paramInt1), (paramInt2 + m) * i);
      return;
    }
  }
