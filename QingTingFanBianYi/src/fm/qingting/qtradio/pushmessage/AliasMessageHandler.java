  ...
  private IResultRecvHandler resultRecver = new IResultRecvHandler()
  {
    public void onRecvResult(Result paramAnonymousResult, Object paramAnonymousObject1, IResultToken paramAnonymousIResultToken, Object paramAnonymousObject2)
    {
      if (paramAnonymousResult.getSuccess())
      {
        ...
        {
          paramAnonymousResult.channelId = AliasMessageHandler.this.mChannelId;
          AliasMessageHandler.this.writeToDB(paramAnonymousResult);
  ...
  private boolean handleMsg(String paramString)
  {
    ...
    while (true)
    {
      ...
      try
      {
        ...
        {
          this.mCategoryId = paramString.getIntValue("cat_id_v6");
          this.mChannelId = paramString.getIntValue("channel_id_v6");
          this.mProgramId = paramString.getIntValue("program_id_v6");
          this.mContentType = 1;
        ...
        while (true)
        {
          ...
          else
          {
            if (!str.equalsIgnoreCase("activity"))
              break;
            int i = paramString.getIntValue("version");
