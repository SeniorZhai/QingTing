...
public class VoiceObject extends BaseMediaObject
{
  ...
  {
    public VoiceObject createFromParcel(Parcel paramAnonymousParcel)
    {
      return new VoiceObject(paramAnonymousParcel);
    }

    public VoiceObject[] newArray(int paramAnonymousInt)
    {
      return new VoiceObject[paramAnonymousInt];
    }
  };
