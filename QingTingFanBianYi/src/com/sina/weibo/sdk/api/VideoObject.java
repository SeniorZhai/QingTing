...
{
  public static final Parcelable.Creator<VideoObject> CREATOR = new Parcelable.Creator()
  {
    public VideoObject createFromParcel(Parcel paramAnonymousParcel)
    {
      return new VideoObject(paramAnonymousParcel);
    }

    public VideoObject[] newArray(int paramAnonymousInt)
    {
      return new VideoObject[paramAnonymousInt];
    }
  };
