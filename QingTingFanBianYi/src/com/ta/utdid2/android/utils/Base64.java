...
public class Base64
{
  ...
  public static byte[] encode(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    label192: return localEncoder.output;
  }
    ...
    public Encoder(int paramInt, byte[] paramArrayOfByte)
    {
      ...
      if ((paramInt & 0x1) == 0)
      {
        ...
        if ((paramInt & 0x2) != 0)
          break label101;
        bool1 = true;
        label33: this.do_newline = bool1;
        if ((paramInt & 0x4) == 0)
          break label106;
        bool1 = bool2;
        label47: this.do_cr = bool1;
        if ((paramInt & 0x8) != 0)
          break label111;
        paramArrayOfByte = ENCODE;
        label63: this.alphabet = paramArrayOfByte;
        ...
        if (paramBoolean)
        {
          if (paramInt2 - this.tailLen == i1 - 1)
          {
            ...
            while (true)
            {
              ...
              label736: if (($assertionsDisabled) || (this.tailLen == 0))
                break;
              throw new AssertionError();
              m = paramInt2 + 1;
          ...
          if (paramInt2 - this.tailLen == i1 - 2)
          {
            ...
            while (true)
            {
              ...
              paramInt2 = m;
              break label810;
              label1012: m = paramArrayOfByte[paramInt2];
              paramInt2 += 1;
            }
          }
          i = paramInt1;
 ...
 * Qualified Name:     com.ta.utdid2.android.utils.Base64
