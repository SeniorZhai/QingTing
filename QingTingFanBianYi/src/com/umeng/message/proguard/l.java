...
class l
{
  ...
  {
    h localh = new h();
    localh.setOutput(paramOutputStream, "utf-8");
    localh.startDocument(null, Boolean.valueOf(true));
    localh.setFeature("http://xmlpull.org/v1/doc/features.html#indent-output", true);
    a(paramMap, null, localh);
    localh.endDocument();
  }
