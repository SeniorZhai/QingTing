...
public final class $Gson$Types
{
    ...
    implements ParameterizedType, Serializable
  {
    ...
    public ParameterizedTypeImpl(Type paramType1, Type paramType2, Type[] paramArrayOfType)
    {
      ...
      label160: for (paramType1 = null; ; paramType1 = .Gson.Types.canonicalize(paramType1))
      {
    ...
    public WildcardTypeImpl(Type[] paramArrayOfType1, Type[] paramArrayOfType2)
    {
      if (paramArrayOfType2.length <= 1)
      {
        ...
        if (paramArrayOfType1.length != 1)
          break label87;
        bool1 = true;
        label27: .Gson.Preconditions.checkArgument(bool1);
        if (paramArrayOfType2.length != 1)
          break label97;
      ...
      label97: .Gson.Preconditions.checkNotNull(paramArrayOfType1[0]);
