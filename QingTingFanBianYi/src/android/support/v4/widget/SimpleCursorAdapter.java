  ...
  public void bindView(View paramView, Context paramContext, Cursor paramCursor)
  {
    ...
    if (i < j)
    {
      ...
      while (true)
      {
        i += 1;
        break;
        label132: if (!(localView instanceof ImageView))
          break label153;
        setViewImage((ImageView)localView, paramContext);
      }
      label153: throw new IllegalStateException(localView.getClass().getName() + " is not a " + " view that can be bounds by this SimpleCursorAdapter");
    }
  }
