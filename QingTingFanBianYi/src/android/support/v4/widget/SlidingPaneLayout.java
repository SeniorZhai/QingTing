...
public class SlidingPaneLayout extends ViewGroup
{
  ...
  private void parallaxOtherViews(float paramFloat)
  {
    ...
    while (true)
    {
      ...
      i = 0;
      break;
      label72: int m = (int)((1.0F - this.mParallaxOffset) * this.mParallaxBy);
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (this.mFirstLayout)
      if ((!this.mCanSlide) || (!this.mPreservedOpenState))
        break label108;
    View localView;
    label108: for (float f = 1.0F; ; f = 0.0F)
    {
      this.mSlideOffset = f;
      paramInt4 = 0;
      paramInt2 = paramInt1;
    ...
    if (localLayoutParams.slideable)
    {
      ...
      {
        paramBoolean = true;
        label211: localLayoutParams.dimWhenOffset = paramBoolean;
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    label292: paramInt1 = localLayoutParams.leftMargin + localLayoutParams.rightMargin;
    if (localLayoutParams.width == -2)
    {
      paramInt1 = View.MeasureSpec.makeMeasureSpec(i1 - paramInt1, -2147483648);
      label325: if (localLayoutParams.height != -2)
        break label506;
      j = View.MeasureSpec.makeMeasureSpec(paramInt2, -2147483648);
      label344: localView.measure(paramInt1, j);
    ...
    label543: for (boolean bool2 = true; ; bool2 = false)
    {
      ...
      break label325;
      label506: if (localLayoutParams.height == -1)
      {
        ...
        while (true)
        {
          ...
          else
          {
            while (true)
            {
              ...
              break label643;
              label736: if (localLayoutParams.height == -1)
              {
    ...
    label643: label786: label921: setMeasuredDimension(i1, i);
    label771: this.mCanSlide = bool1;
