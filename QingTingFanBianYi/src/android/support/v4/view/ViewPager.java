...
public class ViewPager extends ViewGroup
{
  ...
  public boolean arrowScroll(int paramInt)
  {
    ...
    while (true)
    {
      ...
      localObject = null;
      break;
      label249: bool = localView.requestFocus();
      continue;
      label258: if (paramInt == 66)
      {
        i = getChildRectInPagerCoordinates(this.mTempRect, localView).left;
        j = getChildRectInPagerCoordinates(this.mTempRect, (View)localObject).left;
        if ((localObject != null) && (i <= j))
        ...
        else
        {
          ...
          continue;
          label321: if ((paramInt == 17) || (paramInt == 1))
            bool = pageLeft();
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    while (true)
    {
      ...
      label368: for (f1 = this.mInitialMotionX + this.mTouchSlop; ; f1 = this.mInitialMotionX - this.mTouchSlop)
      {
        this.mLastMotionX = f1;
  ...
  void populate(int paramInt)
  {
    ...
    while (true)
    {
      ...
      i = 17;
      break;
      label64: if (this.mPopulatePending)
      {
        sortChildDrawingOrder();
        return;
      }
      if (getWindowToken() != null)
      {
        ...
        if (localObject3 != null)
        {
          ...
          if (n >= 0)
          {
            ...
            if (f2 < 2.0F)
            {
              ...
              label483: f3 = getPaddingRight() / getClientWidth();
              i = this.mCurItem + 1;
              localObject4 = localObject1;
              if (i < i1)
              {
        ...
        label1182: for (localObject1 = ((ItemInfo)localObject3).object; ; localObject1 = null)
        {
          ...
          for (f1 = f2; ; f1 = f2)
          {
            ...
            n = i;
            break;
            label817: localObject1 = null;
          }
          label825: if ((localObject4 != null) && (m == ((ItemInfo)localObject4).position))
          {
          ...
          while (true)
          {
            ...
            m = paramInt;
            break;
            label1054: localObject1 = null;
            f1 = f2;
            paramInt = m;
          }
          label1065: if ((localObject4 != null) && (i == ((ItemInfo)localObject4).position))
          {
            f1 = f2 + ((ItemInfo)localObject4).widthFactor;
            paramInt = m + 1;
            if (paramInt < this.mItems.size());
